...
function optionsframework_options() {
  ...
  $options[] = array(
      'name' => __( 'Show search bar in Top Menu navigation bar?', 'basestation' ),
      'desc' => __( 'Default is disabled. Check this box to turn it on.', 'basestation' ),
      'id'   => 'basestation_search_bar',
      'std'  => '0',
      'type' => 'checkbox'
    );
